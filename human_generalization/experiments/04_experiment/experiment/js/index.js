...
function init() {
  ...
  exp.training_stims = [
      ...
      {condition:"training", item: "real", category:"verb",context:"John said he wants to XXX. Yesterday, his partner YYY and John decided he wanted to try.", root:"cook", prompt:"John said he wants to cook. Yesterday, his partner cook[BLANK1] and John decided he wanted to try."},
  ...
  var items =  [
    ...
    {condition: "filler", item: "real", category: "adjective", context: "XXX things are nice. Some people disagree, but quite a few think XXX things are great. Well, at least everyone can agree that the YYY one of all is really nice. Nothing is YYY than that one.", root: "soft", prompt: "Soft things are nice. Some people disagree, but quite a few think soft things are great. Well, at least everyone can agree that the soft[BLANK1] one of all is really nice. Nothing is soft[BLANK2] than that one."},
